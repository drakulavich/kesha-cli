...
- ONNX export: [klebster/g2p_multilingual_byT5_tiny_onnx](https://huggingface.co/klebster/g2p_multilingual_byT5_tiny_onnx) by Kleber Noel.
...
### symphonia-adapter-libopus + libopus

BSD-3-Clause. Opus decoding shim + upstream codec.
