...
|---|---------|----------|--------------------|---------------------|
| 1 | 10.4s | 14.1s | Проверь все свои конфиги и перенеси секреты в .env файл. | Проверь все свои конфиги и перенеси секреты в дот энф файл. |
| 2 | 8.6s | 1.8s | Вынеси еще секрет от Клода, который я тебе добавил. | Вынеси еще секрет от Клода, который я тебе добавил. |
| 3 | 8.3s | 1.9s | Установи пока Клод Код | Установи пока клот кот. |
| 4 | 11.0s | 1.8s | Какие еще Telegram-юзеры имеют доступ к тебе? | Какие еще телеграм юзеры имеют доступ к тебе? |
| 5 | 9.1s | 1.7s | Закомите изменения в ГИТ | Закомить изменения в Гетт. |
| 6 | 11.0s | 1.8s | Узнай второго юзера в телеграме. | Узнай второго юзера в телеграме. |
| 7 | 11.0s | 1.9s | Ты добавил себе в память информацию из Vantage Handbook-репозитория. | Ты добавил себе в память информацию из Вентеж хендбук репозитория. |
| 8 | 10.1s | 1.8s | Покажи его юзернейм в телеграмме, хочу написать ему. | Покажи его юзернейм в телеграме. Хочу написать ему. |
| 9 | 9.0s | 1.8s | Не нужно ссылать сообщения с транскрипцией. Сразу выполняй инструкцию, которую я отправил Войсу. | Не нужно слать сообщение с транскрипцией, сразу выполняй инструкцию, которую я отправил в войсе. |
| 10 | 7.4s | 1.7s | То, что находится в папке Workspace, ты тоже коммитишь? | То, что находится в папке воркспейс, ты тоже комитишь? |
| **Total** | **95.9s** | **30.3s** | | |

**Parakeet is ~3.2x faster** with CoreML on Apple Silicon.
