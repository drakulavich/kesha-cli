...
|---|---------|----------|--------------------|---------------------|
| 1 | 8.8s | 4.6s | Не нужно посылать сообщение с транскрипцией. Сразу выполняй инструкцию, которую я отправил Войсу. | Не нужно слать сообщения с транскрипцией, сразу выполняй инструкцию, которую я отправил войсе.. |
| 2 | 7.7s | 4.9s | Проверь все свои конфиги и перенеси секреты в .env файл | . Проверь все свои конфигии и перенеси секреты в дотэн файл. |
| 3 | 7.3s | 4.6s | Ты добавил себе в память информацию из Vantage Handbook Репозитория. | Ты добавил себе в память информацию из Вентеж Хэндбук репозитория? |
| 4 | 7.3s | 4s | Покажи его юзернейм в телеграмме, хочу написать ему. | Покажи его юзернейм в Телеграме, хочу написать ему.. |
| 5 | 6.9s | 3.8s | Вынеси еще секрет от Клода, который я тебе добавил. | Вынеси еще секрет от Клода, который я тебе добавил.. |
| 6 | 6.6s | 3.9s | Какие еще Telegram-юзеры имеют доступ к тебе? | Какие еще Телеграм юзеры имеют доступ к тебе? |
| 7 | 6.9s | 3.9s | То, что находится в папке Workspace, ты тоже коммитишь? | То, что находится в папке Воркспэйс, Ты тоже комитешь.. |
| 8 | 6.8s | 3.8s | Узнай второго юзера в телеграме. | Узнай второго юзера в Телеграме.. |
| 9 | 6.3s | 3.6s | Установи пока КЛОТ-КОТ | установи, пока Клот кот.. |
| 10 | 6.1s | 3.6s | Закомите изменения в ГИТ | Законить изменения в Гет. |
| **Total** | **70.7s** | **40.7s** | | |

**Parakeet is ~1.7x faster.**
